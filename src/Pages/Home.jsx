...
export default function Home() {
    return (
        <section className="py-16">
            <div style={{ backgroundImage: `url('/images/bg-triangle.svg')` }} className="relative w-[min(calc(100%-2rem),20rem)] lg:w-[min(calc(100%-2rem),30rem)] mx-auto min-h-60 min-w-[16.1rem]  lg:min-h-72 bg-contain bg-no-repeat bg-center">
