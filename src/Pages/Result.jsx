...
export default function Result({ randomItem, setScore }) {
    ...
    return (
        <section className="space-y-16">
            <div className="flex justify-center items-center gap-16 md:py-8 lg:py-16">

                <div className=" text-center flex flex-col gap-4 lg:gap-8 lg:items-center">
                ...
                <div className="text-center flex flex-col lg:items-center gap-4 lg:gap-8">

                    {
                        showHouseChoice && randomItem ?
                            ...
                            <button className="block mx-auto rounded-full h-24 w-24 sm:h-26 sm:w-26  lg:h-60 lg:w-60 p-3  bg-(--dark-text)">
                    ...
                    <span className="uppercase text-white font-semibold lg:-order-1 lg:text-2xl">the house picked </span>
                </div>
